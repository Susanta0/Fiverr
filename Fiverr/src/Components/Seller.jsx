    ...
    <>
      <div className=" relative">
        ...
        <div className=" w-[100%] text-white absolute top-[50%] flex items-center flex-col gap-4">
          ...
          <button
            onClick={handleMoveSellerCreator}
            className="rounded-md mt-5 px-8 py-2 bg-[#1DBF73] hover:bg-[#12e783] font-semibold"
          >
            Become a Seller
          </button>
        ...
        <div className=" grid grid-cols-4 gap-6 mt-10">
          ...
          <div className="w-[291px] h-[305px] relative bg-[#EEEEEE]">
            <div className="flex flex-col items-center absolute top-[25%] left-[20%]">
              ...
              <button
                onClick={handleMoveSellerCreator}
                className=" mt-6 text-white bg-[#1DBF73] px-6 py-1.5 font-semibold rounded-md hover:bg-[#23aa6b]"
              >
                Become a Seller
              </button>
            </div>
      ...
      <div className="bg-[#F7F7F7] px-40 py-10">
        ...
        <div className="flex mt-16">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-[#555555] text-2xl font-bold">
